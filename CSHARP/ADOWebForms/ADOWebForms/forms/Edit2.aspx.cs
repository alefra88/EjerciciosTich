...
namespace ADOWebForms.forms
{
    ...
    {
            ADOEstatusAlumno _oADOEstadoAlumno = new ADOEstatusAlumno();
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                
                List<EstatusAlumno> list = _oADOEstadoAlumno.ConsultarT();
        ...
        protected void btnActualizar_Click(object sender, EventArgs e)
        {
            ...
            estatus.Id = Convert.ToInt16(txtID.Text);
            estatus.Clave = txtclave.Text;
            estatus.Nombre = txtnombre.Text;
            _oADOEstadoAlumno.Actualizar(estatus);
